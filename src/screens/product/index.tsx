          ...
          <span className="text-gray-500 text-base">
            {productInfo
              ...
              : `Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptate
                rerum recusandae magnam id, dolore commodi magni esse perferendis
                veniam quisquam ipsa saepe officiis nesciunt iure facere sequi qui
                fugit impedit?`}
          </span>
        );
      case "information":
      ...
      <div className="grid grid-flow-col gap-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 sm:gap-16">
          ...
          <div className="flex flex-col gap-3 sm:justify-between">
            ...
            <span className="text-base sm:text-xl text-amber-700">
              {productInfo
            ...
            <p className="text-base text-gray-500">
              {productInfo
                ? productInfo.data.description
                : `Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio voluptatibus consequatur nostrum ipsa nisi nobis minima tempore commodi aliquam, facilis eaque architecto dicta distinctio quidem saepe maiores debitis doloremque corrupti!`}
            </p>
            ...
            <div className="flex gap-6">
              ...
              <Button
                href={ROUTES.Home}
                className="sm:!py-4 !px-12 !border-2"
                fullWidth
                variant="outlined"
                sx={{
                  color: "black",
                  ":hover": { bgcolor: "white", borderColor: "gray" },
                  borderColor: "black",
                }}>
                ADD TO CART
              </Button>
            ...
            <div className="hidden sm:flex">
              SKU : <span className="text-gray-500 text-base">12</span>
            </div>
            <div className="hidden sm:flex">
              Categories :{" "}
              <span className="text-gray-500 text-base">
                {productInfo ? productInfo.data.category : "Fashion, Style"}
              </span>
            </div>
          </div>
        </div>
      ...
      <div>
        <div className="flex flex-col sm:flex-row items-start sm:gap-11 w-full border-b mb-10">
          <Button
            ...
            className={
              active === "Description" ? "!text-black" : "!text-gray-400"
            }>
            Description
          </Button>
          <Button
            ...
            className={
              active === "information" ? "!text-black" : "!text-gray-400"
            }>
            Aditional information
          </Button>
          <Button
            onClick={() => setActive("Reviews")}
            className={active === "Reviews" ? "!text-black" : "!text-gray-400"}>
            Reviews
          </Button>
        </div>
        <div>
