    ...
    return ( 
        <div className="flex flex-col gap-12 w-full">
            <div className="flex max-w-2xl mx-auto flex-col gap-4">
                <h1 className="text-4xl text-center font-medium">Fast Fashion, And Faster Fashion</h1>
                <h3 className="text-base text-center">by ANNY JOHNSON - October 8,2020</h3>
            </div>
            <img src={blog1} className="max-h-500" alt="" />
            <div className="flex max-w-2xl mx-auto flex-col gap-12">
                <p className="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam placerat, augue a volutpat hendrerit, sapien tortor faucibus augue, a maximus elit ex vitae libero. Sed quis mauris eget arcu facilisis consequat sed eu felis. Nunc sed porta augue. 
                ...
                <div className="flex flex-col gap-4">
                    <h3 className="text-2xl">Top Trend</h3>
                    <p className="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam placerat, augue a volutpat hendrerit, sapien tortor faucibus augue, a maximus elit ex vitae libero.</p>
                ...
                <Divider/>
                <Box component={"form"} className="flex flex-col gap-12">
                    <div>
                        <h3 className="text-2xl mb-4">Leave a Reply</h3>
                    ...
                    <Button className="!px-9 !py-4 w-fit" type="submit" variant="contained" sx={{color:"white",bgcolor:"black",":hover":{bgcolor:"black"}}}>Post Comment</Button>
                </Box>
                <Divider/>
                <div>
