...
const CartPage = () => {
    ...
    return ( 
        <div className="mt-6 sm:mt-24 mb-24 sm:mb-48">
            <h1 className="text-xl sm:text-3xl mb-5 sm:mb-16 sm:text-center">shopping Cart</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                ...
                <div className="flex bg-gray-200 rounded sm:bg-white flex-col p-4 sm:px-14 sm:py-10 gap-10">
                    ...
                    <div className="flex gap-12 sm:gap-32">
                        <span>SHIPPING</span>
                        <p className="text-gray-500 max-w-xs">Shipping costs will be calculated once you have provided address.</p>
                    </div>
                    </div>
                    <div className="font-bold flex justify-between">
                        <span>TOTALS</span><span>{ShopppingTotal}</span>
                    </div>
                    <Button className="sm:!mt-10 sm:!py-4" variant="contained" fullWidth sx={{color:"white",bgcolor:"black",":hover":{bgcolor:"black"}}}>PROCEED TO CHECKOUT</Button>
                </div>
            </div>
