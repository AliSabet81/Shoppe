...
const CartProductCard = (i:ICartProductCard) => {
            ...
            <div className="grid grid-cols-2 gap-10">
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        <IconButton onClick={()=>decreaseCartQuantity(product.index)}>-</IconButton>
                        <Typography>{i.quantity}</Typography>
                        <IconButton onClick={()=>increaseCartQuantity(product.index)}>+</IconButton>
                        </div>
                    </div>
